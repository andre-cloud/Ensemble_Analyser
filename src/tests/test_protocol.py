...
def test_protocol():
    ...
    print(json.dumps(p, cls=SerialiseEncoder,))
    print(json.dumps(inp))
    assert json.dumps(p, cls=SerialiseEncoder,) == json.dumps(inp)
...
def test_solvent():
    ...
    assert json.dumps(Solvent(inp), cls=SerialiseEncoder,) == json.dumps(inp)
